...
void Search_One_Section();                       //1区画停止型探索走行
void Maze_Search();                       //連続探索走行
void Maze_Search_Slalom(motion*, motion* ,motion*);
